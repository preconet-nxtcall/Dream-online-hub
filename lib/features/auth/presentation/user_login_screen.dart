...
class _UserLoginScreenState extends State<UserLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userCredentials = TestCredentials.users.where((c) => c.role == 'USER').toList();
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Sign in to access your User Dashboard & Game Cards',
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: const Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.verified_user_rounded, size: 16, color: accentColor),
                                  SizedBox(width: 6),
                                  Text(
                                    'PLAYER USER LOGIN',
                                    style: TextStyle(
                            ...
                            // Switch to Agency Login Link
                            TextButton(
                              onPressed: () => context.go('/agency-login'),
                              child: const Text(
                                'Are you an Agency Manager? Switch to Agency Login ➔',
                                style: TextStyle(
                                  fontSize: 12.5,
                      ...
                      child: Column(
                        children: [
                          ...
                          Wrap(
                            ...
                            spacing: 8,
                            runSpacing: 8,
                            children: userCredentials.map((cred) {
                              return ActionChip(
                                avatar: const Icon(
                                  Icons.person_rounded,
                                  size: 15,
