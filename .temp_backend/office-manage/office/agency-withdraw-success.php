...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: agency-withdraw-success');
}
$msg='';
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Successfull Agency Withdrawal</strong> List</h5>
        </div>
                ...
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" scope="col">Done By</th>
                    ...
                    <?php
                        ...
                        if($_SESSION['u_type'] == "AGENCY" || $_SESSION['u_type'] == "AGENCYS-EMPLOYEE"){
                            $qrydisplay = mysqli_query($conn, "SELECT * FROM `withdrawal` WHERE agency_id = '$emp_id' AND (stage_status = 'AGENCY-DONE' OR stage_status = 'EMPLOYEE-DONE') ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                        } else {
                            $qrydisplay = mysqli_query($conn, "SELECT * FROM `withdrawal` WHERE stage_status = 'AGENCY-DONE' OR stage_status = 'EMPLOYEE-DONE' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                        }
                    ...
                    ?>
                        <tr id="<?php echo $result['id']; ?>">
                            ...
                            <td>
                                ...
                                Transaction ID : <?php echo !empty($result['transaction_id']) ? $result['transaction_id'] : 'N/A'; ?>
                            </td>
                            <td>
                                <?php if($result['stage_status'] == 'EMPLOYEE-DONE'){ ?>
                                    <span class="badge bg-success px-3 py-2">Employee</span>
                                <?php } else { ?>
                                    <span class="badge bg-info text-dark px-3 py-2">Agency</span>
                                <?php } ?>
                            </td>
                            <td>
                                            ...
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    <div class="col-8 text-left">
                                                        <h5 class="modal-title text-white ml-1"><b>Withdrawal Details</b></h5>
                                                    </div>
                                                    ...
                                                    <div class="container-fluid mt-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mx-auto text-center border border-primary shadow py-2">
                                                                ...
                                                                <hr>
                                                                Completed By : <p class="fw-500"><i><?php echo ($result['stage_status'] == 'EMPLOYEE-DONE') ? 'Employee' : 'Agency'; ?></i></p>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-4 mx-auto text-center border border-primary shadow py-2 text-wrap">
                                                                Transaction ID : <p class="fw-500"><i><?php echo !empty($result['transaction_id']) ? $result['transaction_id'] : 'N/A'; ?></i></p>
                                                            </div>
                                                            <div class="col-md-4 mx-auto text-center border border-primary shadow py-2 text-wrap">
