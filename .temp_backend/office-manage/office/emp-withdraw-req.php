...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Employee Withdrawal</strong> Request List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `withdrawal` WHERE stage_status = 'EMPLOYEE-PENDING' AND employee_read_status = 'PENDING' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                    ...
                    ?>
                        <tr id="<?php echo $result['id']; ?>">
                            ...
                            <td> 
                                <button type="button" onclick="upd_emp_withdraw_status('<?php echo $result['id']; ?>')" id="quet_id_<?php echo $result['id']; ?>" class="btn btn_primary py-1 px-2" data-bs-toggle="modal" data-bs-target="#view<?php echo $result['id'];?>" style="vertical-align:middle;">
                                    <i class="bi <?php echo ($result['employee_read_status'] == 'READ') ? 'bi-eye' : 'bi-eye-slash'; ?>"></i>
                                </button>
                                <script>
                                    function upd_emp_withdraw_status(qte_id){
                                        jQuery.ajax({
                                            url: 'ajax_del.php',
                                            type:'post',
                                            data: {
                                                "emp_withdraw_req_upd_status": 1,
                                                "qte_id": qte_id,
                                            },
                                            ...
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-4 text-right">
                                                        <form action="emp-withdraw-req" method="POST">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-12">
                                                                 <div class="card border border-primary shadow-sm">
                                                                     <div class="card-header text-white text-center mx-auto py-1">
