...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: emp-withdraw-success');
}
$msg='';
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Successfull Withdrawal</strong> List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `withdrawal` WHERE stage_status = 'EMPLOYEE-DONE' OR stage_status = 'AGENCY-DONE' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
