...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: complete-subscription');
}
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4" >
        <div class="card-header text-center gradient-15" >
            <h5 class="card-title text-white my-1"><strong>User Subscription</strong> Active List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `subscription` WHERE read_status = 'READ' AND stage_status = 'DONE' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                                            ...
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-4 text-right">
                                                        <form action="complete-subscription" method="POST">
                                                ...
                                                <div class="container-fluid text-dark">
                                                    <div class="container-fluid mt-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mx-auto text-center border border-primary shadow py-2">
                                                                Username :  <p class="fw-500"><i><?php echo $result['username']; ?></i></p>
                                                                <hr>
                                                                Password :  <p class="fw-500"><i><?php echo $result['password']; ?></i></p>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
