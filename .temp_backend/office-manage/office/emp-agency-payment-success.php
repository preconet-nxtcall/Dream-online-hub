...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: emp-agency-payment-success');
}
$msg='';
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Successful Agency Payment</strong> List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `pay_to_admin` WHERE stage_status = 'EMPLOYEE-DONE' OR stage_status = 'ADMIN-DONE' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                    ...
                    ?>
                        <tr id="<?php echo $result['id']; ?>">
                            ...
                            <td>
                                <span class="badge bg-success mb-1">SUCCESSFUL</span><br>
                                <small class="text-muted"><?php echo date('d M Y, h:i A', (int)$result['date_ts']); ?></small>
                            </td>
                            <td> 
                                            ...
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    <div class="col-8 text-left">
                                                        <h5 class="modal-title text-white ml-1"><b>Successful Agency Payment Details</b></h5>
                                                    </div>
                                                    <div class="col-4 text-right">
                                                        <form action="emp-agency-payment-success" method="POST">
