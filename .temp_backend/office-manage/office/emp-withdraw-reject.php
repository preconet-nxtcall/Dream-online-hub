...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: emp-withdraw-reject');
}
$msg='';
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Rejected Withdrawal</strong> List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `withdrawal` WHERE stage_status = 'EMPLOYEE-REJECT' OR stage_status = 'AGENCY-REJECT' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                    ...
                    ?>
                        <tr id="<?php echo $result['id']; ?>">
                            ...
                            <td>
                                <?php if($result['stage_status'] == 'EMPLOYEE-REJECT'){ ?>
                                    <span class="badge bg-danger px-3 py-2">Employee</span>
                                <?php } else { ?>
                                    <span class="badge bg-warning text-dark px-3 py-2">Agency</span>
                                <?php } ?>
                            </td>
                            <td>
                                                    ...
                                                    <div class="container-fluid mt-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mx-auto text-center border border-primary shadow py-2">
                                                                ...
                                                                <hr>
                                                                Rejected By : <p class="fw-500"><i><?php echo ($result['stage_status'] == 'EMPLOYEE-REJECT') ? 'Employee' : 'Agency'; ?></i></p>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                         <div class="row">
