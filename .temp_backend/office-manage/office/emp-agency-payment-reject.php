...
if(ISSET($_POST['modal_close'])){
    $showModal = "";
    header('Location: emp-agency-payment-reject');
}
$msg='';
?>
...
<div class="content mb-4">
    ...
    <div class="card cntnt-start border-rounded shadow mx-4">
        <div class="card-header text-center gradient-15">
            <h5 class="card-title text-white my-1"><strong>Rejected Agency Payment</strong> List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `pay_to_admin` WHERE stage_status = 'EMPLOYEE-REJECT' OR stage_status = 'ADMIN-REJECT' ORDER BY ABS(id) DESC") or die(mysqli_error($conn));
                                            ...
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    <div class="col-8 text-left">
                                                        <h5 class="modal-title text-white ml-1"><b>Rejected Agency Payment Details</b></h5>
                                                    </div>
                                                    ...
                                                    <div class="container-fluid mt-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mx-auto text-center border border-primary shadow py-2 text-wrap">
                                                                Rejection Remark : <p class="fw-500 text-danger"><i><?php echo !empty($result['remark']) ? $result['remark'] : 'N/A'; ?></i></p>
                                                            </div>
                                                            <div class="col-md-6 mx-auto text-center border border-primary shadow py-2 text-wrap">
