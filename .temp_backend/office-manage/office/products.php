...
if(ISSET($_POST['add_product'])){
    ...
    if($_FILES['image']['name']!=''){
        if (($_FILES['image']['size'] > 1048576) || ( $_FILES['image']['type']!='image/png' && $_FILES['image']['type']!='image/jpg' && $_FILES['image']['type']!='image/jpeg' && $_FILES['image']['type']!='image/webp' && $_FILES['image']['type']!='image/avif')){
            ...
            $img_new1=$date_ts.'_Product.'.pathinfo($img1, PATHINFO_EXTENSION);
    ...
    if($msg == ''){
        ...
        if($query){            
            ...
            $_SESSION['text'] = "Product Add Successfully!";
            if(ISSET($_SESSION['swl_type'])){
                header("Refresh:0;");
                exit;
            }
...
if(ISSET($_POST['edit_product'])){
    ...
    if($query){
        ...
        $_SESSION['swl_type'] = "success";
        $_SESSION['head'] = "Successfull !";
        $_SESSION['text'] = "Product Update Successfully!";
        if(ISSET($_SESSION['swl_type'])){
            header("Refresh:0;");
            exit;
        }
...
<div class="content mb-4">
    ...
    <div class="brdcmp px-4 pt-4">
        <div class="d-flex justify-content-between align-items-center pb-4 mb-3">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#insert_partnr" class="btn btn_warning btn-sm">Add Product <i class="bi bi-arrow-right ms-2"></i></button>
        </div>
    </div>

    <div class="card cntnt-start border-rounded shadow mx-4" >
        <div class="card-header text-center gradient-15" >
            <h5 class="card-title text-white my-1"><strong>Products </strong> List</h5>
        </div>
        <div class="card-body pb-0">
            ...
            <div class="modal fade mt-4 pt-4" id="insert_partnr" tabindex="3">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content" style="overflow: visible!importent;">
                        ...
                        <form class="row" action="products" method="post" enctype="multipart/form-data" id="form">
                            <div class="card-body card-block">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">✎</span>
                                            <textarea class="form-control" name="detail" placeholder="Enter Small Description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="d-flex gap-3 mt-3">
                                        <button name="add_product" type="submit" class="mx-auto btn btn-lg one-click btn_primary wave-effect">
            ...
            <div class="table-responsive px-2">
                <table class="display table table-hover text-center" id="example" style="min-width: auto;">
                    ...
                    <?php
                        $i = 0;
                        $qrydisplay = mysqli_query($conn, "SELECT * FROM `features` WHERE type = 'PRODUCT' ORDER BY ABS(id) DESC") or die(mysqli_error());
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        <div class="modal-content" style="overflow: visible!importent;">
                                            <div class="modal-header shadow bg-funky-moon2 mx-auto">
                                                <div class="row mb-1">
                                                    <div class="col-8 text-left">
                                                        <h5 class="modal-title text-white ml-1"><b>Update Product</b></h5>
                                                    </div>
                                                    <div class="col-4 text-right">
                                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid text-dark">
                                                    <form class="row px-2" action="products" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="card-body card-block">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label class="col-sm-4 col-form-label">Small Description</label>
                                                                <div class="col-sm-8">
                                                                    <div class="input-group mb-3">
                                                                        <span class="input-group-text" id="basic-addon1">✎</span>
                                                            ...
                                                            <div class="row">
                                                                <div class="d-flex gap-3 mt-3">
                                                                    <button name="edit_product" type="submit" class="mx-auto btn btn-lg one-click btn_primary wave-effect">
