...
- **Access**: Public
- **Description**: Triggered upon login on PHP login page to sync user or agent profile data directly into MongoDB (`User` or `Agent` document).
- **Request Body**:
  ```json
  {
    "id": 123,
